...
function love.load()
    ...
    player1 = Paddle(VIRTUAL_WIDTH / 2 - 10, 10, 20, 5)
    player2 = Paddle(VIRTUAL_WIDTH / 2 - 10, VIRTUAL_HEIGHT - 15, 20, 5)
...
function love.draw()
    ...
    if gameState == 'start' then
        ...
        love.graphics.printf('Press Enter to begin!', 0, 60, VIRTUAL_WIDTH, 'center')
    elseif gameState == 'serve' then
        -- UI messages
        love.graphics.setFont(smallFont)
...
function displayScore()
    ...
    love.graphics.print(tostring(player1Score), VIRTUAL_WIDTH / 2 - 9,
        VIRTUAL_HEIGHT / 2 + 10)
    love.graphics.print(tostring(player2Score), VIRTUAL_WIDTH / 2 - 9,
        VIRTUAL_HEIGHT / 2 - 40)
end
